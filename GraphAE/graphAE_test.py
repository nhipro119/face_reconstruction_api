...
def test(param,test_npy_fn, out_ply_folder, skip_frames =0):
    ...
    geo_error_avg=float(geo_error_sum)/pc_num
    laplace_error_avg=  float(laplace_error_sum)/pc_num
...
param.read_config("D:\\APIMeshCNN\\train\\0422_graphAE_dfaust\\10_conv_res.config")

#param.augmented_data=True
param.batch =1

param.read_weight_path = "D:\\APIMeshCNN\\train\\0422_graphAE_dfaust\\weight_10\\model_epoch0201.weight"
print (param.read_weight_path)

test_npy_fn = "D:\\data_3D\\ply.npy"

out_test_folder = "D:\\APIMeshCNN\\train\\0422_graphAE_dfaust\\test_10\\"
